package com.autoai.gaspayment.network.response;


import com.autoai.gaspayment.network.Exception.ApiException;
import com.autoai.gaspayment.network.Exception.CustomException;

...
public class KeyboardPopupWindow extends PopupWindow {
     ...
     */
    public KeyboardPopupWindow(Context context, View anchorView, EditText editText, View.OnClickListener sureListener ,boolean isRandomSort) {
...
//            Log.d(TAG, "执行dismiss");
    ...
    private void initView(View.OnClickListener sureListener) {
        parentView = LayoutInflater.from(context).inflate(R.layout.keyboadview, null);
        initKeyboardView(parentView, sureListener);
        setWidth(620);
        setHeight(ViewGroup.LayoutParams.WRAP_CONTENT);
        setContentView(parentView);
    }

    private void initKeyboardView(View view, View.OnClickListener sureListener) {
        Button dropdownLl = view.findViewById(R.id.btn_keyboard_sure);
        dropdownLl.setOnClickListener(sureListener);
